...
namespace Graphics3D
{
    ...
    {
        public static Vector3 SphericalToCartesian(Vector3Spherical vec)
        {
        ...
        public static Vector3Spherical CartesianToSpherical(Vector3 cartCoords)
        {
        ...
        public static float CalculateModule(Vector3 vec)
        {
