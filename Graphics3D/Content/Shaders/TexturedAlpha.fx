...
float4 PixelShaderFunctionA(VertexShaderOutput input) : SV_TARGET0
{
...
technique TexturedAlpha
{
    pass Pass1
    {
        ...
        VertexShader = compile vs_4_0 VertexShaderFunctionA();
        PixelShader = compile ps_4_0 PixelShaderFunctionA();
    }
}