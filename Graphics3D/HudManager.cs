...
namespace Graphics3D
{
    public class HudManager
    {
        ...
        public HudManager(ContentManager content, GraphicsDevice graphicsDevice, SpriteBatch spriteBatch, int width, int height)
        {
            this.content = content;
            this.spriteBatch = spriteBatch;
            this.graphicsDevice = graphicsDevice;

            comboBoxPosX = Convert.ToInt32(0.05 * width);
            comboBoxPosY = Convert.ToInt32(0.05 * height);
            comboBoxWidth = Convert.ToInt32(0.25 * width);
            comboBoxHeight = Convert.ToInt32(0.1 * height);
